...
import { habitScheduledOnDate, isoDate, isCalendarDayInFuture } from "../../lib/domain/tracking";
      ...
      {categories.map((category) => {
        ...
        return <div className="category-group" key={category.id}>
          ...
          {!collapsed && categoryHabits.map((habit) => {
            ...
            const completedThroughToday = currentChecks.filter((day) => day <= evaluatedThrough).length;
