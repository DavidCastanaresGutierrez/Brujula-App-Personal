...
export function NutritionView({ userId }: { userId: string }) {
  ...
  const visibleFrequent = frequent.filter(meal => normalizedMealName(meal.name).includes(normalizedMealName(frequentSearch)));
